  ...
  return (
    <section className="hero-section-ctn flex py-20 relative overflow-hidden min-h-screen">
      <div className="container mx-auto flex items-center justify-between max-w-7xl">
        <div className="text-white max-w-2xl max-md:flex max-md:flex-col max-md:items-center max-md:justify-center">
          <h1 className="text-5xl font-bold mb-10 pl-4 pr-28">
            Your path to trading Mastery
            <span className="text-green-400">starts here</span>
          </h1>

          <button className="ml-4 px-8 py-2 rounded-lg text-white transition-all duration-300 transform hover:scale-90 hover:bg-[linear-gradient(247deg,#00ff80_0%,#C5FF7C_100%)] bg-[linear-gradient(247deg,#00ff80_0%,#C5FF7C_100%)] flex items-center justify-center">
            <span className="text-black">Explore Membership</span>
            <FaArrowRight className="text-[#0E3B43] ml-6" />
          </button>

          <div className="flex flex-col md:flex-row items-center ml-4 mt-8">
